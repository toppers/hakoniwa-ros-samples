...
static colorid_t ev3_color_sensor_get_color()
{
...
int main(int argc, char **argv)
{
	...
	auto publisher = node->create_publisher<ev3_msgs::msg::Ev3PduActuator>("ev3_actuator", 10);
	auto subscriber = node->create_subscription<ev3_msgs::msg::Ev3PduSensor>("ev3_sensor", 10, topic_callback);
