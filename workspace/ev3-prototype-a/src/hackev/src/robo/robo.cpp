...
#include "hackev/Actuator.h"
#include "hackev/Sensor.h"
#include <stdio.h>
...
static void sensorCallback(const hackev::Sensor::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    hackev::Actuator ros_actuator_data;

    ros::Publisher actuator_pub = n.advertise<hackev::Actuator>("actuator", 1);
