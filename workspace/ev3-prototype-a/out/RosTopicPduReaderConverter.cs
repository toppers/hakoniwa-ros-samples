    ...
    class RosTopicPduReaderConverter : IPduReaderConverter
    {
        ...
        static public Message ConvertToMessage(RosTopicPduReader pdu_reader)
        {
            ...
            if (pdu_reader.GetTypeName().Equals("Sensor"))
            {
                ...
                tmp_topic.sensor_color0 = pdu_reader.GetReadOps().GetDataUInt32("sensor_color0");
                tmp_topic.sensor_color1 = pdu_reader.GetReadOps().GetDataUInt32("sensor_color1");
                tmp_topic.sensor_color2 = pdu_reader.GetReadOps().GetDataUInt32("sensor_color2");
                tmp_topic.sensor_reflect0 = pdu_reader.GetReadOps().GetDataUInt32("sensor_reflect0");
                tmp_topic.sensor_reflect1 = pdu_reader.GetReadOps().GetDataUInt32("sensor_reflect1");
                tmp_topic.sensor_reflect2 = pdu_reader.GetReadOps().GetDataUInt32("sensor_reflect2");
                tmp_topic.sensor_rgb_r0 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_r0");
                tmp_topic.sensor_rgb_r1 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_r1");
                tmp_topic.sensor_rgb_r2 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_r2");
                tmp_topic.sensor_rgb_g0 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_g0");
                tmp_topic.sensor_rgb_g1 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_g1");
                tmp_topic.sensor_rgb_g2 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_g2");
                tmp_topic.sensor_rgb_b0 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_b0");
                tmp_topic.sensor_rgb_b1 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_b1");
                tmp_topic.sensor_rgb_b2 = pdu_reader.GetReadOps().GetDataUInt32("sensor_rgb_b2");
                ...
                tmp_topic.sensor_ultrasonic = pdu_reader.GetReadOps().GetDataUInt32("sensor_ultrasonic");
                tmp_topic.touch_sensor0 = pdu_reader.GetReadOps().GetDataUInt32("touch_sensor0");
                tmp_topic.touch_sensor1 = pdu_reader.GetReadOps().GetDataUInt32("touch_sensor1");
                tmp_topic.motor_angle_a = pdu_reader.GetReadOps().GetDataUInt32("motor_angle_a");
                tmp_topic.motor_angle_b = pdu_reader.GetReadOps().GetDataUInt32("motor_angle_b");
                tmp_topic.motor_angle_c = pdu_reader.GetReadOps().GetDataUInt32("motor_angle_c");
