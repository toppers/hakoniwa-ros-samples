...
#include "ev3/Ev3PduActuator.h"
#include "ev3/Ev3PduSensor.h"
#include <stdio.h>
...
static void sensorCallback(const ev3::Ev3PduSensor::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    ev3::Ev3PduActuator ros_actuator_data;

    ros::Publisher actuator_pub = n.advertise<ev3::Ev3PduActuator>("ev3_actuator", 1);
