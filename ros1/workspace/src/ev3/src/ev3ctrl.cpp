...
#include "ev3_msgs/Ev3PduActuator.h"
#include "ev3_msgs/Ev3PduSensor.h"
#include <stdio.h>
...
static void sensorCallback(const ev3_msgs::Ev3PduSensor::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    ev3_msgs::Ev3PduActuator ros_actuator_data;

    ros::Publisher actuator_pub = n.advertise<ev3_msgs::Ev3PduActuator>("ev3_actuator", 1);
